...
MAIN:
  ...
  BTFSS PORTB, 0         ; Testa o bit 0 de PORTB (botão pressionado)
...
passo:
  ...
  BTFSC PORTB, 1
  MOVLW .60              ; Define o atraso com valor inicial de 80 (em X)
  BTFSS PORTB, 1 
  MOVLW .20
...
atraso:
  ...
  BANKSEL PORTB
  BTFSC PORTB, 1 
  MOVLW .40              ; Configura o contador interno com 50
  BTFSS PORTB, 1 
  MOVLW .15
